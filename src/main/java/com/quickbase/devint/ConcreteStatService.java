...
public class ConcreteStatService implements IStatService {
	...
	private static final Logger log = LoggerFactory.getLogger(ConcreteStatService.class);
	...
	public List<Pair<String, Integer>> getCountryPopulations() {
		...
		log.debug("The ConcreteStatService contains {} population record(s) {}", output.size(), output);
